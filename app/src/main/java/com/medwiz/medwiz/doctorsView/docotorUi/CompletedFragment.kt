...
@AndroidEntryPoint
class CompletedFragment:Fragment(R.layout.fragment_completed), ConsultationListener {
    ...
    private fun crateAdapter() {
        adapter = PatientAdapter(requireActivity(),UtilConstants.TYPE_COMPLETED,this)
    ...
    override fun onResume() {
        ...
        if(id.isNotEmpty()){
            consultationViewModel.getConsultationByDocId(token,id.toLong(),UtilConstants.STATUS_COMPLETED)
        }
    }
